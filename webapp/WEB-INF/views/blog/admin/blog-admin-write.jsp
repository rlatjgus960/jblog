	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="admin-content">
				<form id="addPostForm" action="${pageContext.request.contextPath}/${blogVo.id}/admin/write"
					method="get">
					<table id="admin-write">
						...
						<tr>
							...
							<td><select name="cateNo">
									...
									<!-- 카테고리 리스트 영역 -->
									<c:forEach items="${postCateList}" var="postCateList">
										<option value="${postCateList.cateNo}">${postCateList.cateName}</option>
									</c:forEach>
									<!-- 카테고리 리스트 영역 -->
